...
function renderStudyList() {
  ...
  container.innerHTML = visibleItems.map((entry) => {
    ...
    const generatedBadge = item?.chatgptGeneratedOptions
      ? '<div class="generated-options-badge generated-options-badge-study">Варианты сгенерированы с помощью ChatGPT</div>'
      : '';

    return `
      <div class="study-card ${item?.chatgptGeneratedOptions ? 'generated-question-card' : ''}">
...
function showQuestion() {
  ...
  qContainer.innerHTML = `
    ...
    ${q.chatgptGeneratedOptions ? '<div class="generated-options-badge generated-options-badge-test">Варианты сгенерированы с помощью ChatGPT</div>' : ''}
  `;
